(function (global) {
	...
	function init() {
		class LcAdyenApplePayExpressCheckout extends LcAdyenApplePayBaseExpress {
		...
		global.LcAdyenApplePayExpressCheckout = LcAdyenApplePayExpressCheckout;
		document.dispatchEvent(new CustomEvent('LcAdyenApplePayExpressCheckoutReady'));
	}

	if (typeof LcAdyenApplePayBaseExpress !== 'undefined') {
        init();
    } else {
        document.addEventListener('LcAdyenApplePayExpressCheckoutReady', init, { once: true });
    }
})(window);