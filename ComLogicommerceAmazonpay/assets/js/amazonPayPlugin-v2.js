class LcAmazonPay {
    ...
    renderPayButton(target) {
		let amazonPayButton = amazon.Pay.renderButton("#" + target, {
    ...
    loadPayButtonCheckout(merchantId, publicKeyId, payload, signature, accountOrigin) {
        this.accountOrigin = accountOrigin;
        $('body').append($("<div>", { "id":"amazonPayButtonCheckout"}));
        let amazonPayButton = amazon.Pay.renderButton('#amazonPayButtonCheckout', {
    ...
    setAccountOrigin(accountOrigin) {
        this.accountOrigin = accountOrigin;
    }

    getCurrency() {
        if (this.accountOrigin == 'EU') {
            return 'EUR';
        } else if (this.accountOrigin == 'US') {
            return 'USD';
        } else if (this.accountOrigin == 'JP') {
            return 'JPY';
        } else if (this.accountOrigin == 'UK') {
            return 'GBP';
        } else {
            return 'EUR';
        }
    ...
    parseLanguage(language) {
        if (this.accountOrigin == 'US') {   
            return 'en_US';
        }
        if (this.accountOrigin == 'JP') {
            return 'ja_JP';
        }
        switch (language) {
            case 'es':
                return 'es_ES';
            case 'en': {
                if (this.accountOrigin == 'EU' || this.accountOrigin == 'UK') {
                    return 'en_GB';
                }
                return 'en_US';
            }
