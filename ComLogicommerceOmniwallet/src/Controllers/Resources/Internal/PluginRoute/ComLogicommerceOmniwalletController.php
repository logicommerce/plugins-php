...
namespace Plugins\ComLogicommerceOmniwallet\Controllers\Resources\Internal\PluginRoute;
...
use Plugins\ComLogicommerceOmniwallet\Enums\PluginRoutePath;
 ...
 *
 * @package Plugins\ComLogicommerceOmniwallet\Controllers\Resources\Internal
 */
class ComLogicommerceOmniwalletController extends Controller {
    use EnumResolverTrait;

    public const ENDPOINT_POSITION = 1;

    public const SERVICES_PATH = 'Plugins\ComLogicommerceOmniwallet\Services';

    public const PLUGIN_MODULE = 'com.logicommerce.omniwallet';

    public const PLUGIN_PATH_BASE = '/com.logicommerce.omniwallet/';
    ...
    final protected function setControllerBaseData(): void {
        $this->contentType = TwigContentTypes::JSON;
     ...
     * @return object
     */
    private function getServiceObject(string $endPoint, string $pluginMmodule): ?object {        
    ...
    private function checkRoutePlugin(string $pluginModule): void {
        $this->pluginService = Loader::service(Services::PLUGIN);
