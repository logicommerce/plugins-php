...
class WidgetToPageTransformer {
    ...
    private static function widgetToArray(WidgetInstance $widget): array {
        ...
        return [
            ...
            'autoGenerated'    => $widget->getAutoGenerated(),
    ...
    private static function buildPageFromArray(array $pageArray): Page {
        ...
        $page = new Page([
            ...
            'autoGenerated'   => $pageArray['autoGenerated'] ?? null,
        ]);
        ...
        if (isset($pageArray['revision'])) {
            $page->setWidgetRevision((int) $pageArray['revision']);
        }
        if (!empty($subpages)) {
